...
export class LoginComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.getParameterByName('code')!=''){
      window.location.href = "http://localhost:8000/api/getToken?code="+this.getParameterByName('code');
    }
  ...
  onLogin() {
        window.location.href = "https://login.microsoftonline.com/346a1d1d-e75b-4753-902b-74ed60ae77a1/oauth2/authorize?client_id=7c8db090-1712-47dd-aa0b-f34d5357893e&response_type=code&redirect_uri=https://www.calidadacademica.mx&response_mode=query&resource=https://laulatammxqa.crm.dynamics.com";

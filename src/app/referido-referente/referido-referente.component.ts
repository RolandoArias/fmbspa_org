...
export class ReferidoReferenteComponent implements OnInit {
  ...
  onSubmit() {
    ...
    console.log("Num caracteres telefono: "+this.form.value.Telefono.length);
  ...
  for(let i = 0 ; i <= this.ciclos.length ; i++ ){
      if(this.ciclos[i] !== undefined){
        if( this.ciclos[i].crmit_ciclovigenteventas == "True") {
              ...
              console.log("Ciclo Nombre Ventas: "+ciclo_nombreventas);
              console.log("Ciclo Codigo Unico: "+ciclo_codigounico);
...
console.log("Opcion seleccionada de Telefono:");
 ...
 if(this.form.value.tipoCel == "Oficina"){
  ...
  for(let i = 0 ; i < this.subysubsubtipos2.length ; i++ ){
      if( this.subysubsubtipos2[i].crmit_subname == "REFERIDO ONBOARDING" && this.subysubsubtipos2[i].crmit_subsubname == "CREA REFERIDO ONBOARDING"){
      ...
      }else if( this.subysubsubtipos2[i].crmit_subname == "REFERIDO ONBOARDING" && this.subysubsubtipos2[i].crmit_subsubname == "ACTUALIZA REFERIDO ONBOARDING"){
...
Segunda_validacion_Email(email) {
  ...
  resetForm() {
    window.location.href = "/referido-referente";
    this.form.reset();
  }
